...
(function () {
  ...
  const SERVICES = [
    ...
    { id: "on-x", name: "ON.X", pillar: "Experience Platform", onEco: true, stage: "Engage", icon: "sparkles", tagline: "Agentic Assistant", blurb: "A governed assistant that unifies fragmented journeys and acts on your customers' behalf in real time.", priceLabel: "from $7k/mo", typicalRoai: 4.7, popular: true },
    // Commerce Platform
